...
CREATE TABLE IF NOT EXISTS project_specifications (
    ...
    colour VARCHAR(100),
    colour_attachment TEXT,
    ironmongery VARCHAR(150),
    ironmongery_attachment TEXT,
    u_value VARCHAR(100),
    u_value_attachment TEXT,
    g_value VARCHAR(100),
    g_value_attachment TEXT,
    vents VARCHAR(100),
    vents_attachment TEXT,
    acoustics VARCHAR(100),
    acoustics_attachment TEXT,
    sbd VARCHAR(100),
    sbd_attachment TEXT,
    pas24 VARCHAR(100),
    pas24_attachment TEXT,
    restrictors VARCHAR(100),
    restrictors_attachment TEXT,
...
CREATE TABLE IF NOT EXISTS project_rfis (
    ...
    answer_value VARCHAR(10) DEFAULT 'no' CHECK (answer_value IN ('yes', 'no')),
    answered_by BIGINT,
    created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
